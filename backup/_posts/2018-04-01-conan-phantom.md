...
2. 本体补丁用于3DS格式的ROM本身，将3DS文件拖放到补丁程序上进行汉化即可实现汉化；

3. CIA补丁可以用于3DS格式和CIA格式的游戏本体，只要安装CIA补丁，无论你运行的是3DS格式还是安装的CIA格式游戏，都可以实现汉化。同时使用本体补丁和CIA补丁不会有任何不良影响。
...
[[本体补丁]](https://github.com/TeamPBCN/Detective-Conan/releases/download/v1.0/ConanPatcher_v1.0.exe)

[[CIA补丁]](https://github.com/TeamPBCN/Detective-Conan/releases/download/v1.0/Conan_CHS_v1.0.cia)

[[CIA补丁（未加密）]](https://github.com/TeamPBCN/Detective-Conan/releases/download/v1.0/Conan_CHS_no_enc_v1.0.zip)
